...
fun VideoColumn(
    ...
    youtobeResponse: hitfm.uz.domainn.domain.model.YouTubeResponse,
...
fun mapItemsToVideoUiState(items: List<hitfm.uz.domainn.domain.model.Item>): List<VideoUiState> {
