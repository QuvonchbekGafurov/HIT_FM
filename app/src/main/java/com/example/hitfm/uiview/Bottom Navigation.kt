...
fun MainScreen() {
    ...
    val navItemList = listOf(
        NavItem("Radio", Icons.Filled.MusicNote,0),
        NavItem("More", Icons.Filled.MoreHoriz,0),
    )
            ...
            Column {
                ...
                Row(
                    ...
                    Row(modifier = Modifier.align(Alignment.CenterVertically), horizontalArrangement = Arrangement.End,) {
                        ImageInCircle(color = Color.White, image =R.drawable.previus_arrows, imageSize = 25.dp)
                        ...
                        ImageInCircle(color = Color.White, image =R.drawable.next_arrows,imageSize = 25.dp)
